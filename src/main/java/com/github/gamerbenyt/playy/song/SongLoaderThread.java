package com.github.gamerbenyt.playy.song;

import com.github.gamerbenyt.playy.Playy;
import com.github.gamerbenyt.playy.Util;
import com.github.gamerbenyt.playy.conversion.MidiConverter;
import com.github.gamerbenyt.playy.conversion.NBSConverter;
import com.github.gamerbenyt.playy.conversion.TxtConverter;
...
public class SongLoaderThread extends Thread{
	...
	private Path getSongFile(String name) throws IOException {
		return Util.resolveWithIOException(Playy.SONG_DIR, name);
	}
}
