    ...
    public static void addSongItemDisplay(ItemStack stack) {
        getSongItemTag(stack).ifPresent((songItemTag) -> {
            ...
            Util.setItemLore(stack,
                    ...
                    Util.getStyledText("Requires Playy 3.0+", Style.EMPTY.withColor(Formatting.GOLD).withItalic(false)),
                    Util.getStyledText("https://github.com/gamerbenyt/Playy", Style.EMPTY.withColor(Formatting.GRAY).withItalic(false))
            );
        });
    }
